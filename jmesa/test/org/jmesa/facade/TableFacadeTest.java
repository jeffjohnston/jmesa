...
public class TableFacadeTest extends AbstractTestCase {
    ...
    public void getWebContext() {
        ...
        // be the one used.
        assertSame(webContextToSet, facade.getWebContext(), "The web context is not the same.");
    }
    ...
    public void getCoreContext() {
        ...
        // now be the one used.
        assertSame(coreContextToSet, facade.getCoreContext(), "The core context is not the same.");
    }
    ...
    public void addFilterMatcher() {
        ...
        assertEquals(1, filteredObjects.size(), "There are two many filtered items.");
    }
    ...
    public void getLimit() {
        ...
        assertSame(limitToSet, facade.getLimit(), "The limit is not the same.");
    }
    ...
    public void getLimitAndExportable() {
        ...
        assertEquals(limit.hasExport(), true, "The limit is not exportable.");
        assertEquals(limit.getRowSelect().getMaxRows(), limit.getRowSelect().getTotalRows(),
                "The limit maxRows is not the same as the totalRows.");
    }
    ...
    public void getLimitAndNotExportable() {
        ...
        assertEquals(limit.getRowSelect().getMaxRows() != limit.getRowSelect().getTotalRows(), true,
                "The limit maxRows is the same as the totalRows.");
    }
    ...
    public void getToolbar() {
        ...
        // one used.
        assertSame(toolbarToSet, facade.getToolbar(), "The toolbar is not the same.");
    }
    ...
    public void getView() {
        ...
        assertSame(viewToSet, facade.getView(), "The view is not the same.");
    }
    ...
    public void renderAndExportable() {
        ...
        assertEquals(0, response.getContentAsByteArray().length, "The response is not empty.");
    ...
    public void getMaxRows() {
        ...
        assertEquals(15, maxRows, "The maxRows is not set.");
    }
}
